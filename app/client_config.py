...
def build_client_config(device: Device, settings: dict) -> dict:
    ...
    return {"log":{"level":"warn"}, "inbounds":[{"type":"tun","tag":"tun-in","address":["10.254.254.1/30"],"auto_route":True,"strict_route":True,"stack":"mixed"}],
      "outbounds":[
      ...
      "route":{"auto_detect_interface":True,"rules":[{"wifi_ssid":lan_ssids,"action":"route","outbound":"vortex-lan"}],"final":"vortex-remote"}}

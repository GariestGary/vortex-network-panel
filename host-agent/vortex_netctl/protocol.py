...
class RpcRequest(BaseModel):
    ...
    method: Literal["get_status", "get_devices", "add_device", "enable_device", "disable_device", "delete_device", "rotate_device_uuid", "get_subscription_token", "rotate_subscription_token", "revoke_subscription_token", "get_client_template", "validate_client_template", "save_client_template", "list_client_template_versions", "restore_client_template_version", "get_routing", "add_force_vpn", "remove_force_vpn", "add_force_direct", "remove_force_direct", "get_ingress", "test_direct", "test_vpn", "test_destination", "get_recent_logs", "list_backups", "restore_backup"]
    params: dict
